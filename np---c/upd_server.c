...
int main(int argc, char* argv[])
{
	...
	// while binding we tell what ip and port no. the socket will be using 
	...
	// we need this when we recieve the data form the client
	...
	while(1)
	{
		bzero(buffer, 1024);    // 255 is size of the buffer
